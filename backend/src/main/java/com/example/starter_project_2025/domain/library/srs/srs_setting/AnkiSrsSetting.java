...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "anki_srs_settings", uniqueConstraints = @UniqueConstraint(columnNames = "user_id"))
...
@EntityLabel(name = "SRS Setting", plural = "SRS Settings", description = "Per-user SRS settings")
